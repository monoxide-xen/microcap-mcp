...
74 теста, Micro-Cap не требуется: парсер, работа с `.CIR` и чтение лога — чистая обработка
...
Текущий результат — 760 из 866 прогонов, на которые схема способна ответить (88%).
