...
| `draw_schematic` | рисует саму `.CIR`-схему как SVG (символы R/C/L, источников, земли, BJT/MOSFET/ОУ) — Micro-Cap этого в batch не умеет |
...
137 юнит-тестов без Micro-Cap (парсер, `.CIR`, чтение лога, рендер SVG — чистый текст) плюс 30
