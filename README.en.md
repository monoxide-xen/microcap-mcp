...
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/monoxide-xen/microcap-mcp/blob/master/LICENSE)
...
[Русский](https://github.com/monoxide-xen/microcap-mcp/blob/master/README.md) · **English**

<img src="https://raw.githubusercontent.com/monoxide-xen/microcap-mcp/master/docs/assets/hero-ce.svg" width="410" alt="A generated common-emitter stage, drawn 1:1 with Micro-Cap, with its operating point overlaid"> <img src="https://raw.githubusercontent.com/monoxide-xen/microcap-mcp/master/docs/assets/plot-ac.jpg" width="410" alt="Frequency response computed by Micro-Cap">
...
<div align="center">
<img src="https://raw.githubusercontent.com/monoxide-xen/microcap-mcp/master/docs/assets/diffpair.svg" height="200" alt="Differential pair"> <img src="https://raw.githubusercontent.com/monoxide-xen/microcap-mcp/master/docs/assets/cascode.svg" height="200" alt="Cascode"> <img src="https://raw.githubusercontent.com/monoxide-xen/microcap-mcp/master/docs/assets/opamp.svg" height="200" alt="Op-amp amplifier">
</div>

## Install

Needs Windows, Python 3.11+ and an installed copy of [Micro-Cap 12](https://spectrum-soft.com/) (freeware). Nothing to clone — point your MCP client at it and `uvx` fetches the package:
...
- [Micro-Cap notes](https://github.com/monoxide-xen/microcap-mcp/blob/master/docs/micro-cap-notes.en.md) — behaviour that is not in the manual, and in places contradicts it.
